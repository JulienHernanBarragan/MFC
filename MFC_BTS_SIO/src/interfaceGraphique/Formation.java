...
public class Formation extends JFrame {
	...
	public Formation() {
		...
		ajout.setIcon(new ImageIcon(Formation.class.getResource("/image/ajoutformation.png")));
		...
		modif.setIcon(new ImageIcon(Formation.class.getResource("/image/modifformation.png")));
		...
		supp.setIcon(new ImageIcon(Formation.class.getResource("/image/suppformation.png")));
