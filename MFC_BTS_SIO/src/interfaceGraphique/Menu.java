...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		stagiaire.setIcon(new ImageIcon(Menu.class.getResource("/image/stag2.png")));
		...
		deco.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	    		int i = JOptionPane.showConfirmDialog(null,"Etes-vous sur de vouloir vous déconnecter ?","Déconnexion", JOptionPane.YES_NO_OPTION);
					if (i==0) {	
